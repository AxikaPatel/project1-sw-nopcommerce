...
public class TestSuite extends Utility
{
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException
    {
        ...
        String actualMesage = getTextFromElement(By.linkText("Build your own computer"));
        Assert.assertEquals("Error Message Display",actualMesage,expectedMessage);

        //2.6 Select "2.2 GHz Intel Pentium Dual-Core E2200" using Select class
          WebElement drop =  dropDownMenu(By.xpath("//select[@id='product_attribute_1']"));
          Select sel = new Select(drop);
          sel.selectByVisibleText("2.2 GHz Intel Pentium Dual-Core E2200");

        //2.7 Select "8GB [+$60.00]" using Select class.
       WebElement dropDown1 = dropDownMenu(By.xpath("//select[@id='product_attribute_2']"));
       Select s1 = new Select(dropDown1);
        s1.selectByVisibleText("8GB [+$60.00]");
       ...
       //2.11 Verify the price "$1,460.00"
...
//        Assert.assertEquals(expectedMessage1,actualMessage1);
        ...
        clickOnElement(By.xpath("//div[@class='add-to-cart-panel']"));
      ...
      /*2.13  Verify the Message "The product has been added to your shopping cart" on Top
       ...
       // WebElement goToCart = driver.findElement(By.xpath("//button[@class='button-1 cart-button']"));
        ...
        String actualTextMeesage = getTextFromElement(By.xpath("//h1[text()='Shopping cart']"));

        Assert.assertEquals(expectedMessage3,actualTextMeesage);
...
//        Assert.assertEquals(actualMessage4,expectedMessage4);
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"),"Axika");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"),"Patel");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Email']"),"Axika4387@gmail.com");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Company']"),"Axika Ltd.");
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Address2']"),"Alexandra close");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"),"HA2 8QA");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"),"07458932140");
